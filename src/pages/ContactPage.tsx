    ...
    <div className="pt-16 min-h-screen bg-gray-900">
      ...
      <div className="bg-gray-800 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-400">We're here to help with any questions you might have</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
            ...
            <div className="bg-gray-800 rounded-lg p-6 h-full">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      General: info@motoedge.com<br />
                      Sales: sales@motoedge.com<br />
                      Service: service@motoedge.com
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 rounded-full bg-gray-700 flex items-center justify-center hover:bg-red-500 transition-colors">
          ...
          <div className="lg:col-span-2">
            <div className="bg-gray-800 rounded-lg p-6">
              <div className="flex items-center mb-6">
                <MessageSquare className="text-red-500 mr-3" size={24} />
              ...
              {formSubmitted ? (
                <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-4 flex items-center">
                  ...
                  <div>
                    <h3 className="text-white font-medium">Message Sent Successfully!</h3>
        ...
        <div className="mt-12">
          <div className="bg-gray-800 rounded-lg overflow-hidden">
            <div className="aspect-[16/9] relative">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3153.7457086278765!2d-122.41941548481641!3d37.774929919897845!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8085809c6c8f4459%3A0xb10ed6d9b5050fa5!2sDowntown%20San%20Francisco%2C%20San%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1651154407423!5m2!1sen!2sus" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
                allowFullScreen
        ...
        {/* Dealership Photos */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-white mb-6">Our Dealership</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            />
            <img 
              src="https://images.pexels.com/photos/5901020/pexels-photo-5901020.jpeg"
              alt="Dealership Service Center" 
              className="rounded-lg w-full h-48 object-cover"
            />
            <img 
            ...
            />
            <img 
              src="https://images.pexels.com/photos/8985236/pexels-photo-8985236.jpeg" 
              alt="Dealership Parts Department" 
              className="rounded-lg w-full h-48 object-cover"
            />
          </div>
        </div>
